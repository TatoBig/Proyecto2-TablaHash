                        ...
                        for (int i = 0; i < tablaH.maximo; i++) {
                            if(tablaH.tabla[i].libre==false)
                            {
                                for (int j = 0; j < tablaH.tabla[i].valores.size(); j++) {
                                    ...
                                    System.out.println(tablaH.tabla[i].valores.get(j).getID()+"     "+tablaH.tabla[i].valores.get(j).getNombre()+"\n"+tablaH.tabla[i].valores.get(j).getGenero()+"\n"+tablaH.tabla[i].valores.get(j).getAnio());
                                }
                                }
                            }
                        }
